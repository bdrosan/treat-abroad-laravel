    ...
    <main class="flex-grow p-6">
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="mx-auto bg-white mt-3 p-6 rounded-lg shadow-md">
                ...
                <form action="{{ route("admin.departments.update", ['id' => $department->id])  }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input value="{{ $department->name }}" type="text" id="name" name="name" class="w-full p-3 border rounded-lg shadow-sm" required>
                        </div>
