                ...
                <form action="{{ route("admin.blogs.store")  }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1 gap-6">
                        ...
                        <div class="col-span-1">
                            <label for="image" class="block text-gray-700 font-semibold mb-2">Profile
                                Picture
                            </label>
                        ...
                        <div class="">
                            ...
                            <textarea placeholder="Description" id="description" name="description" class="w-full p-3 border rounded-lg shadow-sm"></textarea>
                        </div>

                        <!-- Content -->
                        <div class="">
                            <label for="content" class="block text-gray-700 font-semibold mb-2">Content</label>
                            <textarea placeholder="Content" id="content" name="content" class="w-full p-3 border rounded-lg shadow-sm"></textarea>
                        </div>
